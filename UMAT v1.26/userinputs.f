...
!     -------------------------------------------------------------------------------
!
!     Flag for reading from *.INP file
      integer, public, parameter :: readinpfile = 1
!
!     INP file name
!     In case the file read is not successfull
      character(len=*), parameter, public :: defaultfilename=
     +'Job-1.inp'
!
!     Folder location
!     In case the file read is not successfull
      character(len=*), parameter, public :: defaultfoldername=
     +'/data/engs-dbf-project/engs2474/myscripts/example/'
!
!
!     MESH INPUTS
!     -------------------------------------------------------------------------------
!     Read mesh properties from the INP
!
!     WILL BE USED ONLY WHEN READING FROM *.INP FILE IS TURNED OFF
!     "readininpfile=0"
!
!     Total number of elements in the mesh
!     Adaptive mesh cannot be used!
      integer, public, parameter :: defaultnumel = 1000
!
!     Element type
...
!     Please see meshprop.f for the list of available element types
      character(len=*), parameter, public :: defaulteltyp = 'C3D8'
!
!
!
!     NUMERICAL INPUTS
...
!
!     Predictor schemes
!     0: Weighted average of fully-plastic and fully-elastic guess (Eralp Demir)
!     1: Forward-Gradient (Eralp Demir)
!     2: Stress extrapolation (Chris Hardie)
!     3: Reverse-slip method (Chris Hardie)
!     By default set to be OFF
      integer, parameter, public :: predictor = 1
!
...
!     Default value is set to 0.75
      real(8), parameter, public :: theta = 0.75
!
...
!     0: No GNDs
!     1: curl(Fp) followed L2 method (SVD-inversion)
!     2: curl(Fp) followed L2 method (KKT solution)
!     3: curl(Fp) followed L2 method (SVD-inversion restricted to active SS suggested by Chris Hardie)
...
!     Backstress flag
!     0: No Backstress
!     1: Backstress proportional to GND density
!     (Will only be effect in case any of the GND model is active)
!     Default value is set to 0
