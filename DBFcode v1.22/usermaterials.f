...
!     **********************************************
     ...
     + sintmat1,sintmat2,hintmat1,hintmat2,X) 
      use errors, only : error
      use userinputs, only : maxnslip, maxnparam
!     Temporarily done solution
      use irradiation, only: sintmat_hcp_irm2,
     +  hintmat_hcp_irm2
      implicit none
!
!     material id
...
!     Fraction of hard obstacles on the initial slip resistance
      real(8), intent(out) :: X
...
!
!         steel-ferrite
!         G.V. Kurdjumov, A.G. Khachaturyan, "Nature of axial ratio anomalies of the martensite lattice and mechanism of diffusionless transformation"
!         page 1087
!         C11=233.5d3 
!         C12=135.5d3
!         C44=118.0d3
...
!         Fraction of hard obstacle strength of the initial strength
          X = 0.
...
!         defect vectors (crystallographic directions)
          irradiationparam(8:10) = 11. 
          
!         Fraction of hard obstacle strength of the initial strength
          X = 0.31
          
          
!         Irradiation interaction matrices are assigned to 
!         Strength interaction: sintmat2 (nslip x nloop)
          sintmat2(1:nslip,1:3) = sintmat_hcp_irm2
          
!         Hardening interaction: hintmat2 (nloop x nslip)         
          hintmat2(1:3,1:nslip) = hintmat_hcp_irm2
...
!         Eralp: Burgers vector is not defined for this
          burger1=2.56d-4
