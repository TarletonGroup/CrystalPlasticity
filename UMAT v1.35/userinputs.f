...
!     Adaptive mesh cannot be used!
      integer, public, parameter :: numel = 625
!
!     Element type
...
!     Please see meshprop.f for the list of available element types
      character(len=*), parameter, public :: eltyp = 'C3D8'
!
!
!
!     NUMERICAL INPUTS
...
!     2: curl(gdotnFp) followed by projections (H.Dai, PhD Thesis, 1997.)
!     3: slip gradients followed by projections (Gerken, J.M. and Dawson, P.R., 2008.)
!     4: Gurtin's measure for incompatibility - L2 - SVD - Active SS restriction (Cermeli, P. and Gurtin, M.E., 2001)
!     Default value is set to 0
      integer, parameter, public :: gndmodel = 1
!
!     GND threshold
