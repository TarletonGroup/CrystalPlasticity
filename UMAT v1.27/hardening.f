...
!
!     increase in tauc due to solute force
      real(8),intent(out) :: dtausolute_dg(nslip)
      
!     crss increment
      real(8),intent(out) :: dtauc_dg(nslip,nslip)
!
!     total ssd density increment
      real(8),intent(out) :: drhotot_dg(nslip)
!
!     forest dislocation density increment
      real(8),intent(out) :: drhofor_dg(nslip,nslip)
!
!     substructure dislocation density increment
      real(8),intent(out) :: drhosub_dg(nslip)
!
!     ssd density increment
      real(8),intent(out) :: dssd_dg(nslip,nslip)
!
!     loop density increment
      real(8),intent(out) :: dloop_dg(maxnloop,nslip)
!      
...
!         Solute strength
          ...
          do is=1,nslip
              ...
              dtausolute_dg(is) = -taus0*dexp(-totgammasum/gammasat)
     + /gammasat
...
!         Compute the evolution (annihiliation)
     ...
     + sqrt(loop_t(il)) / burgerv(is) * absgammadot(is) * dt
                  ...
                  dloop_dg(il,is) = - hintmat2(il,is) *
     + sqrt(loop_t(il)) / burgerv(is) 
...
!             Burgers vector
     ...
     + absgammadot(is)*dt
              ...
              dssd_dg(is,is) = k1*dsqrt(rhofor_t(is))-k2*ssd_t(is)
...
!                 Burgers vector
     ...
     + k2*rhofor_t(is)*absgammadot(is)*dt
                  ...
                  drhosub_dg(is) =q*f*dsqrt(rhosub_t)* 
     + k2*rhofor_t(is)
                  
                  drhofor_dg(is,is) = 
     + k1*dsqrt(rhofor_t(is))-k2*rhofor_t(is)
