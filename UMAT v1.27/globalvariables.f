...
!
!
!     Number of iterations to find solution (CDH - 09/02/23)
      real(8), allocatable, public :: statev_iter(:,:)
!
...
!     -------------------------------------------------------------------------------
!
!     Flags for outputs (15-20 custom outputs)
      integer, public :: statev_outputs(20)
!
!
!     Number of outputs - will be computed based on user specifications
...
!      
!     Initialization complete flag for each integration point
!     Gradient operators
      integer, public :: gnd_init
	data    gnd_init     /0/
!
