...
!     Please see meshprop.f for the list of available element types
      character(len=*), parameter, public :: eltyp = 'CPS8'
!
!
!
!     NUMERICAL INPUTS
...
!     Threshold for stress increment
      real(8), parameter, public :: crit = 0.67
!
...
!     1: ON
!     By default set to be ON
      integer, parameter, public :: quadprec = 0
!
...
!     Default value is set to the maximum available material id
      integer, parameter, public :: maxnmaterial = 11
!
...
!     1: use linear interpolation functions (only valid for quadratic elements)
      integer, parameter, public :: gndlinear = 1
!
!     Backstress flag
!     0: No Backstress
