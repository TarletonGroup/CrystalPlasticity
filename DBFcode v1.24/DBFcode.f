...
!         o Different element types for GND calculation
...
!     Subroutine for initialization      
     ...
     + statev_tausolute_t, statev_tausolute, time_old
     ...
     + gndmodel3, gndmodel4, gndmodel5, gndmodel6
!
      implicit none
!
...
!             
!             Curl followed by L2 minimization - Singular Value Decomposition
              if (gndmodel==1) then

                  call gndmodel1

!             Curl followed by L2 minimization - KKT condition
...
!             Rate form using the norm as a scalar quantity
              elseif (gndmodel==4) then
                  
                  call gndmodel4(DTIME(1))
                  
!             Slip gradients
              elseif (gndmodel==5) then

                  call gndmodel5(DTIME(1))
                  
!             Curl followed by L2 minimization - Singular Value Decomposition with shutting down slip systems
              elseif (gndmodel==6) then

                  call gndmodel6(DTIME(1))
