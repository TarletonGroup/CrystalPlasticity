...
!     -------------------------------------------------------------------------------
!
!     Flags for different outputs (19-20 custom outputs)
...
!
     ...
     + statev_tauc, statev_ssd, statev_loop, statev_gnd_t,
     + statev_forest
      use userinputs, only: maxnslip, maxnloop
...
!
          i = i + 1
          gnd = statev_gnd_t(noel,npt,:)
          statev(i) = sqrt(sum(gnd*gnd))     
!
      end if
!
!
!     Custom state variables 19-20
