...
!     Subroutines that need to run once at the beginning of calculations
     ...
     + hintmat1_all, hintmat2_all, X_all,
...
!     Fraction of hard obstacles of the initial strength
      real(8) :: X
!     Allocatable arrays
!     Slip direction
...
!         Fraction of obstacles in the initial strength
          X = props(10)          
...
!
!
!     Fraction of hard obstacles in the initial strength
      X_all(matid) = X
!
!
!
