...
!     Calculate crss
     ...
     + tauc_t(1:nslip), rhotot_t(1:nslip), 
     + sumrhotot_t, rhofor_t(1:nslip), 
     + substructure_t, tausolute_t, 
     + loop_t, imodel, iparam, mattemp,
     + tauceff_t(1:nslip))
...
!         Calculate crss
     ...
     + sintmat2(1:nslip,1:nslip),
     + tauc(1:nslip), rhotot(1:nslip), sumrhotot, 
     + rhofor(1:nslip), substructure, 
     + tausolute, loop, irradiationmodel, 
     + irradiationparam, mattemp,
     + tauceff(1:nslip))
