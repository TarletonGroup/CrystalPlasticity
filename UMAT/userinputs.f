...
!     By default set to be ON
      integer, parameter, public :: stateupdate = 1
!
!
!     Predictor schemes
...
!
!     Inverted Newton Loop as backup predictor (see Hardie et al. 2023: https://www.sciencedirect.com/science/article/pii/S0749641923002577)
!     0: Don't use
!     1: Use
      integer, parameter, public :: inversebackup = 0
!     Tolerance for the reverse scheme
      real(8), parameter, public :: guesstolerance = 10.0 ! MPa.s
...
!     Default value is set to 0.1
      real(8), parameter, public :: phi = 0.0
!
