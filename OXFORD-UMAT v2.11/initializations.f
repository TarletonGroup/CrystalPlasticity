...
!     Reading additional input files
      ...
      use userinputs, only: numel, 
     + voxfilename, foldername, readmaterialfile
      use globalvariables, only: Euler
      integer iele
      real(8) dummy(8)
!
!
...
!
!
!         PROPS(265-300) are intentionally left empty!
!
!
      endif
!
...
!     Initialize forest density per slip system
      statev_forest(noel,npt,1:maxnslip)=rhofor_0
      statev_forest_t(noel,npt,1:maxnslip)=rhofor_0
!
!     Initialize total ssd density
      statev_substructure(noel,npt)=rhosub_0
      statev_substructure_t(noel,npt)=rhosub_0
!
!
!
!
...
!     Arrays allocated
      ...
      use globalvariables, only : Euler, numpt, numdim, materialid,
