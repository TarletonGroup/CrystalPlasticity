...
!     based on element type
     ...
     + Nmat, invNmat, dNmat, dNmatc, ipweights, calculategradient
      use userinputs, only : eltyp, numel, gndlinear, gndmodel
...
!
          GPcoords_C3D15 = 0.
          GPcoords_C3D15(1,:) = (/ 2./3., 1./6., -1. /)
          GPcoords_C3D15(2,:) = (/ 1./6., 1./6., -1. /)
          GPcoords_C3D15(3,:) = (/ 1./6., 2./3., -1. /)
          GPcoords_C3D15(4,:) = (/ 2./3., 1./6.,  0. /)
          GPcoords_C3D15(5,:) = (/ 1./6., 1./6.,  0. /)
          GPcoords_C3D15(6,:) = (/ 1./6., 2./3.,  0. /)
          GPcoords_C3D15(7,:) = (/ 2./3., 1./6.,  1. /)
          GPcoords_C3D15(8,:) = (/ 1./6., 1./6.,  1. /)
...
!     Done only once at the first run
     ...
     + gradip2ip, ipweights
      use userinputs, only : eltyp, numel, gndlinear
